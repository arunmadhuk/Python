...
class Ui_pomodoroTimer(object):
    def setupUi(self, pomodoroTimer):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("pomodoro-technique.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.lcd_timer = QtWidgets.QLCDNumber(parent=self.verticalLayoutWidget)
        self.lcd_timer.setMinimumSize(QtCore.QSize(75, 75))
        self.lcd_timer.setMaximumSize(QtCore.QSize(75, 75))
        font = QtGui.QFont()
        ...
        self.lcd_timer.setProperty("intValue", 25)
